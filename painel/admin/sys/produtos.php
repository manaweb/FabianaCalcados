...
<?
	...
	$campos = array(
		...
		array('texto',		'CATEGORIA',					'colecao_categoria',			''),
	);
	...
	$SQL = "SELECT p . * , concat(co.nome , ' >> ', cat.nome) as colecao_categoria ,cat.id_categoria
			FROM tbprodutos_colecao co, tbprodutos p, tbprodutos_categoria cat
			WHERE co.id_colecao = cat.id_colecao
