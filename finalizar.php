<?php
	if(isset($_GET['id'])){
		...
		$conexao = db_conectar();
		define ("DOMINIO", "http://www.fabianacalcados.com.br");
	...
	<body style='font-family: Century Gothic !important;width: 1100px;margin: auto;'>
		<div style='width: 1000px;margin: auto;padding: 50px;'><!--tudo-->
			<table>
				<tr>
					...
					<td>
						<img src='http://fabianacalcados.com.br/img/logo.jpg' alt='Fabiana Calçados'>
					</td>
		...
		for($i = 0; $i < sizeof($cookies); $i++){
			...
			$msg.="
						<tr>
							<td>
								<a href='".DOMINIO."/verproduto.php?id=".$dadosCarrinho['id']."'>
							...
							<td>".utf8_encode($meuArray['variacao'])."</td>
						</tr>";
		...
		$msg.="		</tbody>
			...
			<div style='margin-top: 100px; 0; width: 1000px;'><!--dadosEmpresa-->
				...
				<p style='font-size: 17px;'>Endereço<br></p>
				<p style='font-size: 17px;'>(16) </p>
				<p style='font-size: 17px;'>contato@fabianacalcados.com.br</p>

				<div style='float: right;  margin-top: -65px;'><!--Logo Mana-->
					<a href='http://www.manaweb.com.br' target='_blank'><img src='http://fabianacalcados.com.br/img/logomana.png' alt='Maná Web'></a>
				</div><!--/Logo Mana-->
			</div><!--/dadosEmpresa-->
		</div><!--/tudo-->
	</body>
		...
		$opts = array(
			...
			'nomeRemetente' => 'Fabiana Calçados',
